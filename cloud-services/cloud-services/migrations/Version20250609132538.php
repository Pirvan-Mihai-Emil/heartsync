 ...
 */
final class Version20250609132538 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE allergy ADD patient_id INT NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE severity severity VARCHAR(255) DEFAULT NULL, CHANGE reaction reaction TEXT DEFAULT NULL, CHANGE notes notes TEXT DEFAULT NULL, CHANGE is_active is_active TINYINT(1) DEFAULT 1, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE allergy ADD CONSTRAINT fk_allergy_patient FOREIGN KEY (patient_id) REFERENCES patient (id) ON UPDATE NO ACTION ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_allergy_patient ON allergy (patient_id)
        SQL);
        $this->addSql(<<<'SQL'
