 ...
 */
final class Version20250609143114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recommendation ADD patient_id INT NOT NULL, CHANGE activity_type activity_type VARCHAR(255) NOT NULL, CHANGE additional_notes additional_notes LONGTEXT DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE is_active is_active TINYINT(1) DEFAULT 1 NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_433224D26B899279 ON recommendation (patient_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_433224D26B899279 ON recommendation
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recommendation DROP patient_id, CHANGE activity_type activity_type VARCHAR(100) NOT NULL, CHANGE additional_notes additional_notes TEXT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE is_active is_active TINYINT(1) DEFAULT 1
        SQL);
        $this->addSql(<<<'SQL'
