...
class getLexikJwtAuthentication_KeyLoaderService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\RawKeyLoader('E:\\heartsync/config/jwt/private.pem', 'E:\\heartsync/config/jwt/public.pem', $container->getEnv('JWT_PASSPHRASE'), []);
    }
}
