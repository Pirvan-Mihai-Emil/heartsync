...
class getAuthControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.7qDibyy'] ?? $container->load('get_ServiceLocator_7qDibyyService'))->withContext('App\\Controller\\AuthController', $container));
