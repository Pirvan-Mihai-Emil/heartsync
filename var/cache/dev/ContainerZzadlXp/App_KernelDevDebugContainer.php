...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('v66LUXHYNm', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SgDGRQooNW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EHg1ixfEBW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E889a3Bn2l', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FqtZXRof90', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\DefaultController', 'App\\Controller\\RegistrationController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'E:\\heartsync/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('E:\\heartsync/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['E:\\heartsync\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'E:\\heartsync\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'E:\\heartsync', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('10fpRMuP9C', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hlKd72JQ-o', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0CojBXkC72', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I85e1JM8K0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a1e-Y6Dbto', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XKvKwHrHrJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'E:\\heartsync', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['E:\\heartsync\\src\\Entity'], true)), 'App\\Entity');
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\ConsultatiiRepository' => ['privates', 'App\\Repository\\ConsultatiiRepository', 'getConsultatiiRepositoryService', true],
            'App\\Repository\\DiagnosticeRepository' => ['privates', 'App\\Repository\\DiagnosticeRepository', 'getDiagnosticeRepositoryService', true],
            'App\\Repository\\DoctoriRepository' => ['privates', 'App\\Repository\\DoctoriRepository', 'getDoctoriRepositoryService', true],
            'App\\Repository\\MedicamenteRepository' => ['privates', 'App\\Repository\\MedicamenteRepository', 'getMedicamenteRepositoryService', true],
            'App\\Repository\\PacientiRepository' => ['privates', 'App\\Repository\\PacientiRepository', 'getPacientiRepositoryService', true],
            'App\\Repository\\RecomandariRepository' => ['privates', 'App\\Repository\\RecomandariRepository', 'getRecomandariRepositoryService', true],
            'App\\Repository\\ReteteMedicaleRepository' => ['privates', 'App\\Repository\\ReteteMedicaleRepository', 'getReteteMedicaleRepositoryService', true],
            'App\\Repository\\TrimiteriRepository' => ['privates', 'App\\Repository\\TrimiteriRepository', 'getTrimiteriRepositoryService', true],
        ], [
            'App\\Repository\\ConsultatiiRepository' => '?',
            'App\\Repository\\DiagnosticeRepository' => '?',
            'App\\Repository\\DoctoriRepository' => '?',
            'App\\Repository\\MedicamenteRepository' => '?',
            'App\\Repository\\PacientiRepository' => '?',
            'App\\Repository\\RecomandariRepository' => '?',
            'App\\Repository\\ReteteMedicaleRepository' => '?',
            'App\\Repository\\TrimiteriRepository' => '?',
        ])));
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'E:\\heartsync', true);
    }
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.login' => ($container->privates['.security.request_matcher.J_sERJN'] ?? $container->load('get_Security_RequestMatcher_JSERJNService'));
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.cy.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.cy.xlf'], 'da' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mk' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.mk.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.mk.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.mk.xlf'], 'mn' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'ur' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations', 'E:\\heartsync/translations', 'E:\\heartsync\\vendor\\symfony\\framework-bundle/translations', 'E:\\heartsync\\vendor\\doctrine\\doctrine-bundle/translations', 'E:\\heartsync\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\debug-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\twig-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\web-profiler-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\stimulus-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\ux-turbo/translations', 'E:\\heartsync\\vendor\\twig\\extra-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\security-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\monolog-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\maker-bundle/translations', 'E:\\heartsync\\vendor\\lexik\\jwt-authentication-bundle/translations'], 'cache_vary' => ['scanned_directories' => ['E:\\heartsync\\vendor\\symfony\\validator/Resources/translations', 'E:\\heartsync\\vendor\\symfony\\form/Resources/translations', 'E:\\heartsync\\vendor\\symfony\\security-core/Resources/translations', 'translations', 'E:\\heartsync\\vendor\\symfony\\framework-bundle/translations', 'E:\\heartsync\\vendor\\doctrine\\doctrine-bundle/translations', 'E:\\heartsync\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\debug-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\twig-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\web-profiler-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\stimulus-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\ux-turbo/translations', 'E:\\heartsync\\vendor\\twig\\extra-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\security-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\monolog-bundle/translations', 'E:\\heartsync\\vendor\\symfony\\maker-bundle/translations', 'E:\\heartsync\\vendor\\lexik\\jwt-authentication-bundle/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\heartsync');
        $a->addPath('E:\\heartsync\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('E:\\heartsync\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('E:\\heartsync\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('E:\\heartsync\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('E:\\heartsync/templates');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\heartsync\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension($h, 'E:\\heartsync', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['E:\\heartsync\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'E:\\heartsync',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'LexikJWTAuthenticationBundle' => [
                    'path' => 'E:\\heartsync\\vendor\\lexik\\jwt-authentication-bundle',
            ...
            'translator.default_path' => 'E:\\heartsync/translations',
            ...
            'twig.default_path' => 'E:\\heartsync/templates',
