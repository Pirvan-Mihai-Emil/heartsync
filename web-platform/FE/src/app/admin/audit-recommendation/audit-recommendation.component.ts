...
@Component({
  selector: 'app-audit-recommendation',
  standalone: true,
  imports: [
    NgForOf,
    NgIf,
  ...
  providers:[ DatePipe],
  templateUrl: './audit-recommendation.component.html',
  styleUrl: './audit-recommendation.component.css'
})
export class AuditRecommendationComponent implements OnInit {
  auditLogs: any[] = [];
  isLoading = false;
  currentEntity = 'recommendation';
