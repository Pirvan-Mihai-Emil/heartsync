...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: './audit-medication.component.html',
  styleUrl: './audit-medication.component.css'
})
export class AuditMedicationComponent implements OnInit {
  auditLogs: any[] = [];
  isLoading = false;
  currentEntity = 'medication';
