...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: './audit-alarms.component.html',
  styleUrl: './audit-alarms.component.css'
})
export class AuditAlarmsComponent implements OnInit {
  auditLogs: any[] = [];
  isLoading = false;
  currentEntity = 'alarm';
