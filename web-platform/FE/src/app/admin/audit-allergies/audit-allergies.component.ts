...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: './audit-allergies.component.html',
  styleUrl: './audit-allergies.component.css'
})
export class AuditAllergiesComponent implements OnInit {
  auditLogs: any[] = [];
  isLoading = false;
  currentEntity = 'allergy';
